"""ASI01 attack tools — same shape as ASI02 with `fetch_url` added.

The malicious payload lives in the *fetched HTML*, not in any tool
description. The agent is honestly serving the user's request when
it fetches the page; it's the page that hijacks it."""
